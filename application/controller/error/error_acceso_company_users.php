...
<div class="main-wrapper">
    ...
    <div class="error-box">
        <div class="error-body text-center">
            <h1 class=" text-danger">ERROR DE USUARIO COMPANY</h1>

            <h3 class="text-uppercase error-subtitle">No se encontro una compañia asociada a este usuario</h3>
            <h3><b> <?= $_SESSION['nom_usuario'];  ?> </b></h3>

            <p  class="text-muted m-t-30 m-b-30">Este error solo suele ocurrir cuando el usuario no tiene asociado una compañia o el usuario no se encuentra registrado de manera correcta
                <br> para corregir este problema consulte con soporte <b>0987722863</b></p>
